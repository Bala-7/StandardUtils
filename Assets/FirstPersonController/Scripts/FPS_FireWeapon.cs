...
public class FPS_FireWeapon : FPS_Weapon
{
    ...
    public override void Fire()
    {
        if (canShoot)
        {
            Vector3 shootPos = transform.parent.parent.position + _player.GetComponent<FPS_Camera>().GetForwardDirection() * 1.0f + new Vector3(0, -0.1f, 0);
            ...
            rb.velocity = _player.GetComponent<FPS_Camera>().GetForwardDirection() * 40.0f;
